...
if (D_COMPILER)
    get_filename_component(D_COMPILER ${D_COMPILER} ABSOLUTE BASE_DIR ${CMAKE_BINARY_DIR})
...
elseif($ENV{DMD} MATCHES ".+")
    get_filename_component(D_COMPILER_TEMP $ENV{DMD} ABSOLUTE BASE_DIR ${CMAKE_BINARY_DIR})
    get_filename_component(D_COMPILER ${D_COMPILER_TEMP} PROGRAM PROGRAM_ARGS D_COMPILER_FLAGS_ENV_INIT CACHE)
    if(D_COMPILER_FLAGS_ENV_INIT)
        set(D_COMPILER_FLAGS "${D_COMPILER_FLAGS_ENV_INIT}" CACHE STRING "Default flags for D compiler")
    endif()
    if(NOT EXISTS ${D_COMPILER})
