...
Expression *eval_llvmsqrt(Loc loc, FuncDeclaration *fd,
...
Expression *eval_llvmlog(Loc loc, FuncDeclaration *fd, Expressions *arguments) {
  ...
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
  return new RealExp(loc, ldouble(arg0->toReal().log()), type);
}

Expression *eval_llvmfabs(Loc loc, FuncDeclaration *fd,
                          Expressions *arguments) {
  Type *type = getTypeOfOverloadedIntrinsic(fd);
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
...
Expression *eval_llvmminnum(Loc loc, FuncDeclaration *fd,
                            Expressions *arguments) {
  Type *type = getTypeOfOverloadedIntrinsic(fd);
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
  ...
  return new RealExp(
      loc, longdouble::fmin(ldouble(arg0->toReal()), ldouble(arg1->toReal())),
      type);
}

Expression *eval_llvmmaxnum(Loc loc, FuncDeclaration *fd,
                            Expressions *arguments) {
  Type *type = getTypeOfOverloadedIntrinsic(fd);
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
  ...
  assert(arg1->op == TOKfloat64);
  return new RealExp(
      loc, longdouble::fmax(ldouble(arg0->toReal()), ldouble(arg1->toReal())),
      type);
}

Expression *eval_llvmfloor(Loc loc, FuncDeclaration *fd,
                           Expressions *arguments) {
  Type *type = getTypeOfOverloadedIntrinsic(fd);
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
...
Expression *eval_llvmceil(Loc loc, FuncDeclaration *fd,
                          Expressions *arguments) {
  Type *type = getTypeOfOverloadedIntrinsic(fd);
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
...
Expression *eval_llvmtrunc(Loc loc, FuncDeclaration *fd,
                           Expressions *arguments) {
  Type *type = getTypeOfOverloadedIntrinsic(fd);
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
...
Expression *eval_llvmround(Loc loc, FuncDeclaration *fd,
                           Expressions *arguments) {
  Type *type = getTypeOfOverloadedIntrinsic(fd);
  Expression *arg0 = (*arguments)[0];
  assert(arg0->op == TOKfloat64);
