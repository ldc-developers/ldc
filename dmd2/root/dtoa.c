...
/*
   Small modifications to this file made by Johan Engelen for LDC
*/
...
// only compile this file for MSVC <= 2013
#if _MSC_VER <= 1800
...
#ifdef __cplusplus
extern "C" double strtod_davidgay(const char *s00, char **se);
extern "C" char *dtoa_davidgay(double d, int mode, int ndigits,
