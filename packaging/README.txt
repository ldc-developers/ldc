...
available from Microsoft. LDC relies on the MS linker and MSVCRT + WinSDK libs.

The compiler configuration file is etc\ldc2.conf, and by default only import\
resp. import\ldc\ are on the module search path.
...
DUB 1.0+ works seamlessly together with LDC. If you have different D compilers
installed then you need to use the --compiler=<path to ldc2.exe or ldmd2.exe>
option with DUB.
