...
// RUN: %ldc -c -mdcompute-targets=ocl-220 -m64 -output-ll -output-o -spirv-debug %s && FileCheck %s --check-prefix=LL < kernels_ocl220_64.ll && llvm-spirv -to-text kernels_ocl220_64.spv && FileCheck %s --check-prefix=SPT < kernels_ocl220_64.spt
